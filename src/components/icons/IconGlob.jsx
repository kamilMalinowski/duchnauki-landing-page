function IconGlob() {
  return (
    ...
    >
      ...
      />
      <path
        className="icon-glob__arrow"
        d="M16.7576 21.9397L13.5908 13.5909L21.9396 16.7577L18.2374 18.2375L16.7576 21.9397Z"
        stroke="#226CE0"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="2"
